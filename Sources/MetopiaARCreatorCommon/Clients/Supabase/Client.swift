...
public class SupabaseClient: ClientProtocol {
  ...
  public required init(
    url: URL, key: String, authenticationClient: NetworkRequestAuthProtocol? = nil,
    storageClient: NetworkRequestStorageProtocol? = nil,
    serviceClient: NetworkRequestServiceProtocol? = nil
  ) {
    self.url = url
