...
public protocol ClientProtocol {
  ...
  init(
    url: URL, key: String, authenticationClient: (any NetworkRequestAuthProtocol)?,
    storageClient: (any NetworkRequestStorageProtocol)?,
    serviceClient: (any NetworkRequestServiceProtocol)?)
